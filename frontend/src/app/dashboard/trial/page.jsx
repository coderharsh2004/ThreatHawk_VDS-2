...
// //           <h1 className="text-2xl font-semibold text-neutral-900">Network Scanner</h1>
...
// //                 {/* Add more scan types if supported by the API */}
// //               </select>
// //               <svg
...
// //       {/* Scan Results */}
// //       {scanResult ? (
// //         <div className="mt-8">{renderNmapResults(scanResult)}</div>
// //       ) : (
...
// bg-white p-6 rounded-lg shadow-sm border border-neutral-200">
//           <h3 className="text-lg font-semibold text-neutral-900 mb-4">Scan Metadata</h3>
//           <p className="text-sm text-neutral-600">
//             <strong>Report ID:</strong> {result.report_id || "N/A"}
//           </p>
...
//             <div className="flex items-center">
//               <div className="rounded-full p-3 bg-gray-100">
//                 <svg className="w-6 h-6 text-gray-dept text-neutral-600"></svg><p>Filtered Ports</p>
//                 <h3 className="text-xl font-bold text-neutral-900">{result.summary?.filtered_ports || 0}</h3>
//               </div>
//             </div>
//           </div>
